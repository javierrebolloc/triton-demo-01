...
def pgie_src_pad_buffer_probe(pad, info, u_data):
    ...
    while l_frame is not None:
        ...
        obj_data = {
                ...
                "num_surfaces_per_frame": frame_meta.num_surfaces_per_frame,
                "width": frame_meta.source_frame_width ,
                "height": frame_meta.source_frame_height ,
                "surface_type": frame_meta.surface_type ,
                "surface_index ": frame_meta.surface_index
            }
        #FUNCIONA
        #Convertir el mensaje a un JSON y luego a bytes
        message_json = json.dumps(obj_data)  # convierte el diccionario a cadena JSON
        message_bytes = message_json.encode('utf-8')  # convierte la cadena JSON a bytes
